...
readingTime: 4
draft: false
summary: "I stopped memorizing LeetCode solutions and started solving problems by hand first, then looking for the underlying pattern — arrays, two pointers, sliding window, binary search, DP, trees, graphs, hash maps. The goal isn't problem count; it's being able to explain the reasoning in an interview."
faq:
  - question: "Why did I start learning DSA if I already work as a Data Engineer?"
    answer: "Day-to-day work is pipelines, SQL and cloud tooling, but technical interviews test a different skill — problem solving under time pressure — so I started a dedicated LeetCode practice to build that muscle."
  - question: "What was the biggest mistake I made early on?"
    answer: "Reading the solution before really attempting the problem. Every new problem felt unrelated because I was memorizing answers instead of learning how to think through them."
  - question: "What process do I follow now?"
    answer: "Understand the problem, solve it manually with a small example, identify the underlying pattern, write the optimized solution, then analyze time and space complexity."
  - question: "What's the actual goal?"
    answer: "Not raw problem count — understanding the logic well enough to explain my thought process confidently in an interview."
---
